    ...
    return (
        <div className="max-w-7xl mx-auto px-4 min-h-[80vh] flex items-center justify-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full max-w-6xl">
                ...
                >
                    <div className="w-20 h-20 bg-forest rounded-3xl flex items-center justify-center shadow-2xl">
                        <Shield className="text-leaf w-10 h-10" />
                    </div>
                    <h1 className="text-6xl font-display font-black text-forest leading-tight">
                        Join the <span className="text-leaf italic">Elite</span> Movement
                    </h1>
                    <p className="text-xl text-forest/60 font-medium leading-relaxed max-w-md">
                    ...
                    <div className="flex gap-8 pt-4">
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs font-bold text-forest/30 uppercase tracking-widest">Verified Members</span>
                        </div>
                        <div className="flex flex-col">
                ...
                >
                    ...
                    <form className="space-y-6">
                        {!isLogin && (
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" placeholder="John Doe" className="w-full pl-12 pr-4 py-4 rounded-2xl bg-forest/5 border-none focus:ring-2 focus:ring-leaf outline-none font-medium" />
                                </div>
                            </div>
                        )}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-forest/20 w-5 h-5" />
                                <input type="email" placeholder="john@example.com" className="w-full pl-12 pr-4 py-4 rounded-2xl bg-forest/5 border-none focus:ring-2 focus:ring-leaf outline-none font-medium" />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input type="password" placeholder="••••••••" className="w-full pl-12 pr-4 py-4 rounded-2xl bg-forest/5 border-none focus:ring-2 focus:ring-leaf outline-none font-medium" />
                            </div>
                        </div>

                        <button className="forest-gradient text-ivory w-full py-5 rounded-2xl font-black text-lg shadow-2xl hover:scale-[1.02] transition-all flex items-center justify-center gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-2 py-4 rounded-xl border border-forest/10 hover:bg-forest/5 transition-all font-bold text-sm">
                    ...
                    <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-forest/5 rounded-full blur-3xl" />
                </motion.div>
            </div>
        </div>
    );
