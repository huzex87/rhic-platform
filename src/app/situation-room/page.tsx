            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8 space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-6">
                            ...
                            <div className="premium-card">
                                <h3 className="text-sm font-black text-foreground/40 uppercase tracking-widest mb-6 py-2 border-b border-apc-red/10">Active Reports</h3>
                                <div className="space-y-4">
                                    {[1, 2, 3].map((i) => (
                                        <div key={i} className="flex items-start gap-4 p-3 rounded-xl bg-foreground/5 hover:bg-foreground/10 transition-colors cursor-pointer group border border-apc-red/5">
                                            <div className="w-10 h-10 rounded-xl apc-cyan-gradient flex items-center justify-center shrink-0 text-white font-black text-xs">
                                                #{i}
                                            </div>
                                            <div>
                                                <div className="text-sm font-black text-foreground group-hover:text-apc-cyan transition-colors">Tactical Update {i}</div>
                                                <div className="text-[10px] font-bold text-foreground/30 uppercase mt-0.5">Lagos Sector • 12:4{i} PM</div>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                <button className="w-full mt-4 py-3 rounded-xl bg-foreground/5 text-[10px] font-black text-foreground/40 uppercase tracking-widest hover:bg-foreground/10 transition-all border border-foreground/10">
                                    Clear Operational Log
                                </button>
                            </div>
                        </div>

                        <div className="premium-card apc-red-gradient text-white">
                            <div className="flex items-center gap-3 mb-4">
                                <Shield className="w-6 h-6 text-white" />
                                <h3 className="font-display font-black text-xl">Tactical Alert</h3>
                            </div>
                            <p className="text-sm text-white/80 font-medium mb-6">
                                Unauthorized activity detected in the NE sector. Immediate response units required for situational stabilization.
                            </p>
                            <button className="w-full bg-white text-apc-red py-3 rounded-xl font-black text-sm shadow-xl hover:scale-[1.02] transition-all border border-apc-red/20 shadow-apc-red/20">
                                DEPLOY RESPONSE
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="premium-card">
                        ...
                        <div className="flex justify-between mt-4 text-[10px] font-black text-foreground/20 uppercase tracking-[0.2em]">
